...
const ReviewCard = ({ name, text, delay = 0 }) => {
  return (
    <Reveal
      delay={delay}
      className="flex-1 min-w-80 max-w-60 sm:max-w-[320px] bg-[#ffffff] border-2 border-[#D46B43] rounded-3xl shadow-lg p-5 sm:p-6 flex flex-col hover:-translate-y-1 hover:shadow-2xl transition-all duration-300"
    >
