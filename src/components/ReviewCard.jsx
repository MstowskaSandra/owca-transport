...
const ReviewCard = ({ name, text, delay = 0 }) => {
  return (
    <Reveal
      delay={delay}
      className="flex-1 w-full min-w-0 max-w-[320px] bg-[#ffffff] border-2 border-[#D46B43] rounded-3xl shadow-lg p-5 sm:p-6 flex flex-col hover:-translate-y-1 hover:shadow-2xl transition-all duration-300"
    >
