...
export const ServiceSection = ({ service, variant = "left" }) => {

  const isRight = variant === "right";
    return (
        <div className="py-16  lg:py-20 font-text px-6 lg:px-12 max-w-7xl mx-auto bg-[#ffffff] rounded-3xl shadow-md">
            <div 
                className={`flex flex-col md:flex-row items-center gap-8 md:gap-16 ${
                isRight ? "md:flex-row-reverse" : ""
                }`}
            >
                <div className="w-full md:w-1/2 space-y-8 font-mont ">
                ...
                <ul className="space-y-3 pl-2">
                    ...
                    >
                        ...
                        <span className="mt-2.5 h-1.5 w-1.5 shrink-0 rounded-full bg-[#D46B43]" />
                        <span>{feature}</span>
                    </li>
                    ))}
                </ul>
                ...
                <div className="w-full md:w-1/2">
                    <div className="overflow-hidden rounded-3xl shadow-xl border-4 border-gray-100 transform hover:scale-[1.02] transition duration-300">
                        ...
                        src={service.imgUrl}
                        alt={service.name}
                        className="w-full h-75 sm:h-100 object-cover bg-gray-100"
                        />
