const FeatureCard = ({ icon: Icon, title, description }) => {
  return (
    <div className="bg-white border-4 border-[#C2B7B2] rounded-[36px] px-6 py-6 flex flex-col items-center text-center transition-all duration-300 hover:-translate-y-1 hover:shadow-2xl shadow-md w-full sm:max-w-85 mx-auto min-h-60 ">
